...
package cva6_barebones_pkg;
	...
	// SRAM Configurations
	localparam int unsigned sram_size = 256 * 1024; // 256 KB
	...
	localparam int unsigned axi_periph_cnt = 5; // Number of peripherals on the AXI crossbar
	...
	localparam axi_pkg::xbar_rule_64_t [axi_periph_cnt-1:0] addr_map = '{
		...
		'{ idx: DEV_KECCAK, start_addr: 64'h5000_1000, end_addr: 64'h5000_1000 + 64'h0000_1000 }
	};
