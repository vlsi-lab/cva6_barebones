...
// Date: September 2025                                                              //
// Desc: Entry point for testing the ML-KEM implementation (Ascon symmetric         //
//       primitives) using input and expected output test vectors                   //
//                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////
...
int main(void)
{
    ...
    //*************************************************
        ...
        print_uart("\n");
        print_uart("Number of retired instructions for crypto_kem_keypair_derand: ");
    ...
    //*************************************************
        ...
        print_uart_dec(cycles);
        print_uart("\n");
        print_uart("Number of retired instructions for crypto_kem_enc_derand: ");
        print_uart_dec(instrs);
        print_uart("\n");
    ...
    //*************************************************
        ...
        print_uart_dec(cycles);
        print_uart("\n");
        print_uart("Number of retired instructions for crypto_kem_dec: ");
        print_uart_dec(instrs);
        print_uart("\n");
