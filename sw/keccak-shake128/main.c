// TPA benchmark - Keccak-f[1600] tightly-coupled accelerator, configured for
...
// ISE custom instructions (xor5/xandn/rxri) via the KeccakF1600_StatePermute
// routine in keccak_permute.s; otherwise a pure-software C Keccak-f[1600]
// permutation runs on the base RV64 core. Permutation input/output vectors
// mirror the SHAKE KAT.
...
// Keccak-f[1600] permutation, implemented with the hash ISE in keccak_permute.s
